...
public class FinanceInputThread extends Thread {
	public void run() {
		System.out.println(" ");
		System.out.println("10초 안에 주어진 질문에 대답하세요.");
		System.out.println("How much do you have money?");
		String userInput = JOptionPane.showInputDialog("How much do you have money?");
		String answer = "Fight?";
...
//		System.out.println("내가 입력한 값은 " + userInput);
		...
		if(userInput.equals(answer)) {
			...
			System.out.println(" ");
			금융자격증.후니의_서류지수_증가(10);
			금융자격증.후니의_체력지수_감소(10);
			금융자격증.후니의_스트레스지수_증가(10);
			금융자격증.후니의_자존감지수_증가(10);
			System.out.println(" ");
